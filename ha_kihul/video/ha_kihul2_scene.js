window.scene = {
    ...
    "main": {
        ...
        "events": [
            ...
            {"key": "g", "effect": {"type": "scale", "scale": 2.0, "duration": 22.0, "rewind": 35.0}},
            {"key": "g", "effect": {"type": "translate", "offset": [-440, -1160], "duration": 22.0, "rewind": 35.0}},
        ...
        "children": [
            ...
            },
            {
                ...
                "z": 900,
                "events": [
                    {"key": "x", "effect": {"type": "translate", "offset": [-192, -804], "duration": 21.0, "rewind": 0.1}},
                    {"key": "x", "effect": {"type": "scale", "scale": 1.6, "duration": 21.0, "rewind": 0.1}},
                    {"key": "v", "effect": {"type": "translate", "offset": [-24, 0], "duration": 1.0}},
                    {"key": "o", "effect": {"type": "opacity", "opacity": 0.0, "duration": 3.0, "rewind": 0.1}}
                ],
                "children": [
                ]
            },
            ...
            },
            {
                ...
                "children": [
                    ...
                    },
                    {
                        ...
                        "z": 3100,
                        "events": [
                            {"key": "9", "effect": {"type": "translate", "offset": [-410, 1700], "duration": 0.1, "rewind": 0.1}},
                    ...
                    },
                    {
                        ...
                        "z": 3100,
                        "events": [
                            {"key": "8", "effect": {"type": "translate", "offset": [-370, 1460], "duration": 0.1, "rewind": 0.1}},
