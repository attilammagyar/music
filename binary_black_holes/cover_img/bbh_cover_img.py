...
# articles about black hole visualization (e.g. [3], [4]) and watching all the
...
# bad idea, but PyPy [8] can make this script surprisingly fast. It uses Pillow
# [10] for image processing. The song is distributed under CC-BY-SA 3.0 [9], and
# this script is WTFPL 2 [11].
#
